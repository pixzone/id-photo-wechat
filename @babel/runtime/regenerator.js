    ...
    if (h) u && (module.exports = h); else {
        ...
        h.isGeneratorFunction = function(t) {
            ...
            return r.reverse(), function e() {
                for (;r.length; ) {
                    var n = r.pop();
                    if (n in t) return e.value = n, e.done = false, e;
                }
            ...
            constructor: N,
            reset: function(t) {
                if (this.prev = 0, this.next = 0, this.sent = this._sent = r, this.done = false, this.delegate = null, 
        ...
        if (t) {
            ...
            if (!isNaN(t.length)) {
                var o = -1, a = function e() {
                    for (;++o < t.length; ) if (n.call(t, o)) return e.value = t[o], e.done = false, e;
